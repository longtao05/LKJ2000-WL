...
def initGol():
    mygolList=['StopSendActReply','PlanCancelledFlag','serialPort','LOG','PlanCancelled','WLFileFlag','UpdataModeType','UpgradePlanVer','StopFlag','TrainNum','DataType','OrderID','VoucherCode','ManCode']
